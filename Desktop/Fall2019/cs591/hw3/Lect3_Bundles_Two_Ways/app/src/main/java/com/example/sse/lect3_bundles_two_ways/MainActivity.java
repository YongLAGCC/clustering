...
//        }
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {    //Passing Data Between Activities
            ...
            public void onClick(View v) {
                ...
                i.putExtra("secretVal", "CS 591");  //OPTIONAL for message passing between activities, basically just a hashmap, this bundle will be passed with intent.
     //           i.putExtra("secretVal2", "43");  //OPTIONAL for message passing between activities, basically just a hashmap, this bundle will be passed with intent.
